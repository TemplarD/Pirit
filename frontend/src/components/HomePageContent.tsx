      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 rounded-lg h-96 flex items-center justify-center">
              <div className="text-center">
                <p className="text-xl text-gray-700 dark:text-gray-300 mb-4">3D модель в разработке</p>
                <a href="/constructor" className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-semibold">
                  Открыть 2D Конструктор →
                </a>
              </div>
            </div>
            <p className="text-center text-gray-600 dark:text-gray-400 mt-4">
              Попробуйте наш новый 2D конструктор!
            </p>
          </div>
        </div>
      </section>
