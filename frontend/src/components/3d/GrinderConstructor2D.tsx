                ...
                >
                    ...
                    {TEST_NODES.map((node) => {
                      ...
                      return (
                        <div key={node.id} className="border-b border-gray-200 dark:border-gray-700 pb-2 last:border-0">
                          <div className="text-xs text-gray-500 dark:text-gray-400">{t(`constructor.${node.nodeType.toLowerCase()}`) || node.name}</div>
                          {option ? (
                            ...
                            <span className="text-sm text-gray-400">{t('constructor.notSelected')}</span>
                          )}
                        </div>
                      )
                    })}
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                    <div className="flex justify-between text-base font-bold">
                      <span className="text-gray-900 dark:text-white">{t('constructor.total')}</span>
